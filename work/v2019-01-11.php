...
<head>
  ...
  <title>Harmony</title>
  <script src="repos/abcjs/bin/abcjs_basic_5.10.3.js" type="text/javascript"></script>
...
echo "<a href=# class=imgmo2 id=zoom-in><img width=40 style='opacity: 0.15' align=right src=img/zoom-in.png></a><br>";
echo "<a href=# class=imgmo2 id=zoom-out><img width=40 style='opacity: 0.15' align=right src=img/zoom-out.png></a>";
echo "</div>";
//echo "</div>";
...
echo "</div>";
?>
<!-- <script type="module"> import {notation_zoom} from 'js/harmony.js'; </script> -->
