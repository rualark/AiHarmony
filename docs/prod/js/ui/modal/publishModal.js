...
export function showPublishModal() {
  if (environment.includes('serverless')) {
    alertify.warning('Artinfuser Database is not available in this environment. Please visit <a href=https://artinfuser.com>artinfuser.com</a> site for full funcionality', 60);
    return;
  }
